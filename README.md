...
**orb-slam2_with_semantic_labelling** is a  visual SLAM system based on  **[ORB_SLAM2[1-2]](https://github.com/raulmur/ORB_SLAM2)**.
...
![image](https://github.com/qixuxiang/orb-slam2_with_semantic_labelling/blob/master/png/framwork.png)
...
![image](https://github.com/qixuxiang/orb-slam2_with_semantic_labelling/blob/master/png/result.png)
...
## License
Our system is released under a [GPLv3 license](https://github.com/qixuxiang/orb-slam2_with_semantic_labelling/blob/master/License-gpl.txt).
...
- The code can also work on OpenCV3.X and CUDA 9, you can change to OpenCV3.X and CUDA 9 as [CMakeLists.txt](https://github.com/yubaoliu/orb-slam2_with_semantic_labelling/blob/master/CMakeLists.txt).
